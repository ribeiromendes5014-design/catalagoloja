...
def render_carrinho_popover(df_catalogo_completo, df_clientes_cash):
    ...
    with st.popover("Conteúdo do Carrinho"):
        ...
        for prod_id, item in list(carrinho.items()):
            ...
            # Nota: A remoção de itens do carrinho (`remover_do_carrinho`) precisa ser importada de `ui_components.py`
            ...
            # NOTE: Você precisará importar 'remover_do_carrinho' de 'ui_components' para que funcione
            from ui_components import remover_do_carrinho 
        ...
        # NOTE: 'limpar_carrinho' precisa ser importada de 'ui_components' para que funcione
        ...
        with st.form("form_finalizar_pedido", clear_on_submit=True):
            ...
            if st.form_submit_button("✅ Enviar Pedido", type="primary", use_container_width=True):
                if nome_input and contato_input:
                    ...
                    # NOTE: 'salvar_pedido' precisa ser importada de 'data_handler' para que funcione
                    ...
                    if sucesso:
                        ...
                        # Redirecionamento e limpeza de estado
                        js_redirect = f"""
                        <script>
